...
__all__ = ["Spotidl", "console_entry_point", "__version__"]
...
class Spotidl:
    """
    Spotidl class, which simplifies the process of downloading songs from Spotify.

    ```python
    from spotdl import Spotidl

    spotdl = Spotidl(client_id='your-client-id', client_secret='your-client-secret')
